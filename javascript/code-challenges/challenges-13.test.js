...
const standardizePhoneNumbers = (arr) =>
{
  arr.forEach((value, index, array) =>
    {
      let valueAsCharArray = value.split('');
      let formattedString = valueAsCharArray.filter((value) =>
      {
...
const onlyOddChars = (str) =>
{
  ...
  charArray = charArray.filter((value, index) =>
  {
    return index % 2 !== 0;
  });
